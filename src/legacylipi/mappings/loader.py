...
class MappingLoader:
    ...
    def __init__(self, mapping_dirs: Optional[list[Path]] = None):
    ...
    def _find_mapping_file(self, encoding_name: str) -> Optional[Path]:
    ...
    def get_builtin(self, encoding_name: str) -> Optional[MappingTable]:
...
KRUTI_DEV_LIGATURES = {
    "Hkkjr": "भारत", "ns'k": "देश", "d`fr": "कृति",
    "gS": "है", "fd": "कि", "dh": "की", "esa": "में", "ls": "से",
    "dk": "का", "ds": "के", "dks": "को",
}
